...
<!DOCTYPE xsl:stylesheet [ <!ENTITY reg "&#174;"> ]>
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns="http://www.w3.org/1999/xhtml" xmlns:ns1="http://www.tibco.com/schemas/CFEDGSGenerateContent/SharedResources/SchemaDefinitions/EDGSContentService/Application Schema/Schema.xsd" xmlns:ns0="http://carefirst.com/Enterprise/CFEDGSGenerateContent/EDGSRequest"> 
<xsl:variable name="password" select="ns1:InputXML/ns1:password"/>
<xsl:template name="emailsecurity" match="/">
                     ...
                     <tr>
                        <td class="one-column card" bgcolor="#ffffff" style="padding: 0px 35px;">
                           <table width="100%" cellpadding="0" cellspacing="0" border="0" role="presentation">
                              ...
                              <tr>
                                 <td>
                                    <h1 style="font-size: 21px;color: #0099cc;margin:0;font-weight:600;">Your My Account Security Code</h1>
                                 </td>
                              </tr>
                              <tr>
                                 <td height="10"></td>
                              ...
                              <tr>
                                 <td>
                                    <h2><xsl:value-of select="securityCode"/></h2>
									 <p>To continue, please enter the six-digit code shown above. It will expire in 5 minutes. <br/><br/>If you did not request this code, please call us at <a href="tel:877-526-8390" class="nobr" style="color:#086ea1;cursor:pointer;" >877-526-8390</a> Monday - Friday from 7 a.m. to 6 p.m. (Eastern Time).</p>
                                 </td>
                              </tr>
                              <!-- Spacer : BEGIN -->
                              <tr>
